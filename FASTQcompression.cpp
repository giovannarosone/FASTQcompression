...
void process_cluster(uint64_t begin, uint64_t i){
    ...
    /*Through max_qs we obtain the highest qs in the cluster, while through avg_qs we obtain the average qs in the cluster*/
    //avg_qs = avg_qs(start,i);
    maxqs = max_qs(start,i);
    cout << "****\n";
